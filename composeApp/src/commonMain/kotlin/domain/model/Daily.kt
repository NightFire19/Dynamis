...
data class Daily(
    ...
    @SerialName("apparent_temperature_min"      ) var apparentTemperatureMin      : ArrayList<Double> = arrayListOf(),
    ...
    @SerialName("showers_sum"                   ) var showersSum                  : ArrayList<Double> = arrayListOf(),
    @SerialName("snowfall_sum"                  ) var snowfallSum                 : ArrayList<Double> = arrayListOf(),
    @SerialName("precipitation_probability_max" ) var precipitationProbabilityMax : ArrayList<Double> = arrayListOf(),
